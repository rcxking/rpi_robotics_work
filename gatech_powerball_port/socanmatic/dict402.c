...
const canmat_dict_t canmat_dict402 = {
	...
	.btree_name=(canmat_dict_name_tree_t[]){
		{.parameter_name="Abort connection option code",.i=323},
		{.parameter_name="Acceleration dimension index",.i=365},
		{.parameter_name="Acceleration factor",.i=398},
		{.parameter_name="Acceleration factor/Divisor",.i=401},
		{.parameter_name="Acceleration factor/number of entries",.i=399},
		{.parameter_name="Acceleration factor/Numerator",.i=400},
		{.parameter_name="Acceleration notation index",.i=364},
		...
		{.parameter_name="Controlword",.i=325},
		{.parameter_name="Device type",.i=0},
		{.parameter_name="Digital inputs",.i=403},
		{.parameter_name="Digital outputs",.i=404},
		{.parameter_name="Digital outputs/bit mask",.i=406},
		{.parameter_name="Digital outputs/number of entries",.i=405},
		{.parameter_name="Drive catalog number",.i=416},
		{.parameter_name="Drive data",.i=420},
		{.parameter_name="Drive data/number of entries",.i=419},
		{.parameter_name="Drive manufacturer",.i=417},
		{.parameter_name="Emergency consumer",.i=40},
		{.parameter_name="End velocity",.i=355},
		{.parameter_name="Error behavior",.i=41},
		{.parameter_name="Error behavior/communication error",.i=42},
		{.parameter_name="Error Code",.i=324},
		{.parameter_name="Error register",.i=1},
		{.parameter_name="Fault reaction option code",.i=335},
		{.parameter_name="Feed constant",.i=378},
		{.parameter_name="Feed constant/Feed",.i=380},
		{.parameter_name="Feed constant/number of entries",.i=379},
		{.parameter_name="Feed constant/Shaft revolutions",.i=381},
		{.parameter_name="Gear ratio",.i=374},
		{.parameter_name="Gear Ratio/Motor revolutions",.i=376},
		{.parameter_name="Gear Ratio/number of entries",.i=375},
		{.parameter_name="Gear Ratio/Shaft revolutions",.i=377},
		{.parameter_name="Guard time",.i=9},
		{.parameter_name="Halt option code",.i=334},
		{.parameter_name="High resolution time stamp",.i=20},
		{.parameter_name="Home offset",.i=348},
		{.parameter_name="http drive catalog address",.i=418},
		{.parameter_name="http motor catalog address",.i=411},
		...
		{.parameter_name="Max deceleration",.i=402},
		{.parameter_name="Modes of operation",.i=336},
		{.parameter_name="Modes of operation display",.i=337},
		{.parameter_name="Motion profile type",.i=359},
		{.parameter_name="Motor calibrate date",.i=412},
		{.parameter_name="Motor catalog number",.i=409},
		{.parameter_name="Motor data",.i=414},
		{.parameter_name="Motor data/number of entries",.i=413},
		{.parameter_name="Motor manufacturer",.i=410},
		{.parameter_name="Motor Type",.i=408},
		...
		{.parameter_name="Polarity",.i=353},
		{.parameter_name="Position actual value",.i=338},
		{.parameter_name="Position dimension index",.i=361},
		{.parameter_name="Position encoder resolution",.i=367},
		{.parameter_name="Position encoder resolution/Encoder increments",.i=368},
		{.parameter_name="Position encoder resolution/Motor revolutions",.i=369},
		{.parameter_name="Position encoder resolution/number of entries",.i=366},
		{.parameter_name="Position factor",.i=382},
		{.parameter_name="Position factor/Feed constant",.i=385},
		{.parameter_name="Position factor/number of entries",.i=383},
		{.parameter_name="Position factor/Numerator",.i=384},
		{.parameter_name="Position notation index",.i=360},
		{.parameter_name="Position range limit",.i=344},
		{.parameter_name="Position range limit/Max position range limit",.i=347},
		{.parameter_name="Position range limit/Min position range limit",.i=346},
		{.parameter_name="Position range limit/number of entries",.i=345},
		{.parameter_name="Pre-defined error field",.i=3},
		{.parameter_name="Producer heartbeat time",.i=24},
		{.parameter_name="Profile acceleration",.i=356},
		{.parameter_name="Profile deceleration",.i=357},
		{.parameter_name="Profile velocity",.i=354},
		{.parameter_name="Quick stop deceleration",.i=358},
		...
		{.parameter_name="Software position limit",.i=349},
		{.parameter_name="Software position limit/Max position range limit",.i=352},
		{.parameter_name="Software position limit/Min position range limit",.i=351},
		{.parameter_name="Software position limit/number of entries",.i=350},
		{.parameter_name="Statusword",.i=326},
		...
		{.parameter_name="Supported drive modes",.i=415},
		{.parameter_name="Synchronous counter overflow value",.i=30},
		{.parameter_name="Synchronous window length",.i=6},
		{.parameter_name="Target position",.i=343},
		{.parameter_name="Target velocity",.i=407},
		...
		{.parameter_name="Velocity actual value",.i=340},
		{.parameter_name="Velocity demand value",.i=339},
		{.parameter_name="Velocity dimension index",.i=363},
		{.parameter_name="Velocity encoder factor",.i=386},
		{.parameter_name="Velocity encoder factor/Divisor",.i=389},
		{.parameter_name="Velocity encoder factor/number of entries",.i=387},
		{.parameter_name="Velocity encoder factor/Numerator",.i=388},
		{.parameter_name="Velocity encoder resolution",.i=370},
		{.parameter_name="Velocity encoder resolution/Encoder increments per second",.i=372},
		{.parameter_name="Velocity encoder resolution/Motor revolutions per second",.i=373},
		{.parameter_name="Velocity encoder resolution/number of entries",.i=371},
		{.parameter_name="Velocity factor 1",.i=390},
		{.parameter_name="Velocity factor 1/Divisor",.i=393},
		{.parameter_name="Velocity factor 1/number of entries",.i=391},
		{.parameter_name="Velocity factor 1/Numerator",.i=392},
		{.parameter_name="Velocity factor 2",.i=394},
		{.parameter_name="Velocity factor 2/Divisor",.i=397},
		{.parameter_name="Velocity factor 2/number of entries",.i=395},
		{.parameter_name="Velocity factor 2/Numerator",.i=396},
		{.parameter_name="Velocity notation index",.i=362},
		{.parameter_name="Velocity threshold",.i=341},
		{.parameter_name="Velocity threshold time",.i=342},
		...
		{.parameter_name="vl actual percentage",.i=332},
		{.parameter_name="vl control effort",.i=329},
		{.parameter_name="vl manipulated percentage",.i=333},
		{.parameter_name="vl percentage demand",.i=331},
		{.parameter_name="vl target velocity",.i=327},
		{.parameter_name="vl velocity demand",.i=328},
		{.parameter_name="vl velocity reference",.i=330},
	},
	.obj=(canmat_obj_t[]){
	{
		.index=0x1000,
