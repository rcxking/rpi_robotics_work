"""autogenerated by genpy from cob_script_server/ScriptActionResult.msg. Do not edit."""
import sys
...
class ScriptActionResult(genpy.Message):
  _md5sum = "363a8255aae19ae465319475e1a86dad"
  _type = "cob_script_server/ScriptActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_script_server/ScriptResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScriptActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_script_server.msg.ScriptResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_script_server.msg.ScriptResult()
