"""autogenerated by genpy from cob_script_server/StateActionResult.msg. Do not edit."""
import sys
...
class StateActionResult(genpy.Message):
  _md5sum = "ce13060ab8a677de81822b61b38a1956"
  _type = "cob_script_server/StateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_script_server/StateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StateActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_script_server.msg.StateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_script_server.msg.StateResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_h.pack(self.result.return_value))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.return_value,) = _struct_h.unpack(str[start:end])
      return self
