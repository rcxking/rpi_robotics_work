"""autogenerated by genpy from cob_script_server/StateAction.msg. Do not edit."""
import sys
...
class StateAction(genpy.Message):
  _md5sum = "8053233aa3e0dd581f127cd6e23e3f9a"
  _type = "cob_script_server/StateAction"
...
"""
  ...
  _slot_types = ['cob_script_server/StateActionGoal','cob_script_server/StateActionResult','cob_script_server/StateActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StateAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_script_server.msg.StateActionGoal()
      if self.action_result is None:
        self.action_result = cob_script_server.msg.StateActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_script_server.msg.StateActionFeedback()
    else:
      self.action_goal = cob_script_server.msg.StateActionGoal()
      self.action_result = cob_script_server.msg.StateActionResult()
      self.action_feedback = cob_script_server.msg.StateActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_h.pack(self.action_goal.goal.state.number))
      _x = self.action_goal.goal.state.function_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.state.component_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.state.parameter_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.state.full_graph_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_bh3I.pack(_x.action_goal.goal.state.state, _x.action_goal.goal.state.error_code, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_h3I.pack(_x.action_result.result.return_value, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.state.header.frame_id = str[start:end]
      start = end
      end += 2
      (self.action_goal.goal.state.number,) = _struct_h.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.state.function_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.state.function_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.state.component_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.state.component_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.state.parameter_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.state.parameter_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.state.full_graph_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.state.full_graph_name = str[start:end]
      _x = self
      start = end
      end += 15
      (_x.action_goal.goal.state.state, _x.action_goal.goal.state.error_code, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_bh3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.return_value, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_h3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
