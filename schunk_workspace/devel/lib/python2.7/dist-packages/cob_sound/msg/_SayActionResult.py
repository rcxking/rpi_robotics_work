"""autogenerated by genpy from cob_sound/SayActionResult.msg. Do not edit."""
import sys
...
class SayActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_sound/SayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_sound/SayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_sound.msg.SayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_sound.msg.SayResult()
