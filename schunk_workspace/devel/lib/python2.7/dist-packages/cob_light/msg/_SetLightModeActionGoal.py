...
class SetLightModeActionGoal(genpy.Message):
  _md5sum = "5a0fbb41ccbcad3e400fdff9a37682eb"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.mode.mode, _x.goal.mode.color.r, _x.goal.mode.color.g, _x.goal.mode.color.b, _x.goal.mode.color.a, _x.goal.mode.frequency, _x.goal.mode.timeout, _x.goal.mode.pulses, _x.goal.mode.priority,) = _struct_B6fib.unpack(str[start:end])
      return self
