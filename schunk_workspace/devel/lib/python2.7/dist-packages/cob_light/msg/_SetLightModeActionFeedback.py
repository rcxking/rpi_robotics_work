"""autogenerated by genpy from cob_light/SetLightModeActionFeedback.msg. Do not edit."""
import sys
...
class SetLightModeActionFeedback(genpy.Message):
  _md5sum = "045111f6fd69e109519fd9865138069c"
  _type = "cob_light/SetLightModeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_light/SetLightModeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetLightModeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_light.msg.SetLightModeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_light.msg.SetLightModeFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.feedback.active_mode, _x.feedback.active_priority))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.active_mode, _x.feedback.active_priority,) = _struct_2B.unpack(str[start:end])
      return self
