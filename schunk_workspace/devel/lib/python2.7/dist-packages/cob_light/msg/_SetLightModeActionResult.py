"""autogenerated by genpy from cob_light/SetLightModeActionResult.msg. Do not edit."""
import sys
...
class SetLightModeActionResult(genpy.Message):
  _md5sum = "c52c8d91f4b68f13492272224c38b274"
  _type = "cob_light/SetLightModeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_light/SetLightModeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetLightModeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_light.msg.SetLightModeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_light.msg.SetLightModeResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.result.active_mode, _x.result.active_priority))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.active_mode, _x.result.active_priority,) = _struct_2B.unpack(str[start:end])
      return self
