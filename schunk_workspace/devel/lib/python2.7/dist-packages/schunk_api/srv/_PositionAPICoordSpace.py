...
class PositionAPICoordSpaceRequest(genpy.Message):
  _md5sum = "ea74c545aa2a56a3edda934edc81763f"
...
"""
  __slots__ = ['xCoord','yCoord','zCoord']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3d.pack(_x.xCoord, _x.yCoord, _x.zCoord))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.xCoord, _x.yCoord, _x.zCoord,) = _struct_3d.unpack(str[start:end])
      return self
...
class PositionAPICoordSpace(object):
  ...
  _md5sum = 'fcb0db018d72d795dd8f562b7c618526'
