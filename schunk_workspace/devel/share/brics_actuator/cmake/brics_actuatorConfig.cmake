...
if("TRUE" STREQUAL "TRUE")
  set(brics_actuator_SOURCE_PREFIX /home/powerball/rpi_robotics_work/schunk_workspace/src/cob_common/brics_actuator)
  set(brics_actuator_DEVEL_PREFIX /home/powerball/rpi_robotics_work/schunk_workspace/devel)
  ...
  set(brics_actuator_INSTALL_PREFIX /home/powerball/rpi_robotics_work/schunk_workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'brics_actuator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Alexander Bubeck <aub@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'brics_actuator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/powerball/rpi_robotics_work/schunk_workspace/src/cob_common/brics_actuator/${idir}'.  Ask the maintainer 'Alexander Bubeck <aub@ipa.fhg.de>' to fix it.")
    endif()
...
set(brics_actuator_EXPORTED_TARGETS "brics_actuator_generate_messages_cpp;brics_actuator_generate_messages_lisp;brics_actuator_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${brics_actuator_dep}_FOUND)
      find_package(${brics_actuator_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${brics_actuator_dep} REQUIRED ${depend_list})
  endif()
