...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name schunk_api-msg:<Position> is deprecated: use schunk_api-msg:Position instead.")))

(cl:ensure-generic-function 'joint1Position-val :lambda-list '(m))
(cl:defmethod joint1Position-val ((m <Position>))
...
(cl:defmethod joint2Position-val ((m <Position>))
...
(cl:defmethod joint3Position-val ((m <Position>))
...
(cl:defmethod joint4Position-val ((m <Position>))
...
(cl:defmethod joint5Position-val ((m <Position>))
...
(cl:defmethod joint6Position-val ((m <Position>))
