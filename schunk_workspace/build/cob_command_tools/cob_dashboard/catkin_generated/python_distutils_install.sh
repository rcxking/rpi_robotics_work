...
cd "/home/powerball/rpi_robotics_work/schunk_workspace/src/cob_command_tools/cob_dashboard"
...
/usr/bin/env \
    ...
    build --build-base "/home/powerball/rpi_robotics_work/schunk_workspace/build/cob_command_tools/cob_dashboard" \
    install \
    $DESTDIR_ARG \
