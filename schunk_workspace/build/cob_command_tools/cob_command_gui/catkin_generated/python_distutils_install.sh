...
cd "/home/powerball/rpi_robotics_work/schunk_workspace/src/cob_command_tools/cob_command_gui"
...
/usr/bin/env \
    ...
    build --build-base "/home/powerball/rpi_robotics_work/schunk_workspace/build/cob_command_tools/cob_command_gui" \
    install \
    $DESTDIR_ARG \
